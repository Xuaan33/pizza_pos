...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    _buildSummaryCards(totalSales, totalOrders, todayInfo, totalVoucherRedemption),
  ...
  Widget _buildSummaryCards(
      double totalSales, int totalOrders, Map<String, dynamic> todayInfo, double totalVoucherRedemption) {
