// Create a new file: refund_dialog.dart
import 'dart:convert';
              ...
              child: Padding(
                ...
                child: CustomScrollView(
                  slivers: [
                    ...
                    // Item Selection for Itemized Refund
                            ...
                            return Container(
                              ...
                              child: Card(
                                ...
                                child: InkWell(
                                  borderRadius: BorderRadius.circular(8),
                                  onTap: () {
                                    _onItemSelectionChanged(item, !isSelected);
                                  },
                                  child: Padding(
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              SizedBox(height: 4),
                                              Text(
                                                'RM ${(totalPrice * quantity).toStringAsFixed(2)} '
              ...
              child: Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    onPressed: _totalRefundAmount > 0
                        ? () {
                            final items =
                            ...
                            if (!isFullRefund && _selectedType == RefundType.itemized &&
            ...
            ? () {
                if (type == RefundType.exchange) {
                  Fluttertoast.showToast(
                    msg: "Exchange feature coming soon",
